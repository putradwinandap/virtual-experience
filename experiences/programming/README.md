...
Programming in Virtual Experience is about encountering the kinds of engineering situations that are difficult to learn from syntax or tutorials alone.

The experiences in this domain focus on recognizing failure patterns, investigating symptoms, making engineering decisions, and understanding the consequences and trade-offs of those decisions.

## Areas

- [Concurrency](concurrency/) — problems that appear when operations can overlap and interact through shared state.
